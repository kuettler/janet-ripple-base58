...
JANET_FN(cfun_base58_checked_decode,
         "(ripple-base58/checked-decode message)",
    ...
    if (version < 0) janet_panicf("Failed to verify checksum: %d", version);
...
JANET_FN(cfun_base58_checked_encode,
         "(ripple-base58/checked-encode message version)",
...
JANET_MODULE_ENTRY(JanetTable *env) {
    ...
    janet_cfuns_ext(env, "ripple-base58", cfuns);
}
